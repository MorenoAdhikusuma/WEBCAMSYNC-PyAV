# main.py (serial-only IMU, UTC+7 ISO timestamps no IMUPlot)
...
class PreviewThread(QThread):
    ...
    def __init__(self, device_index: int, width=1280, height=720, fps=20):
        super().__init__()
...
class MainWindow(QMainWindow):
    ...
    def start_preview(self):
        ...
        for i, cb in enumerate(self.cam_inputs):
            ...
            t = PreviewThread(device_index=dev)
    ...
    def on_extract_finished(self):
        self.extract_btn.setEnabled(True); self.extract_btn.setText("Extract Frames from Session")
